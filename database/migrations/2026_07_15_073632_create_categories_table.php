...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('categories', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('parent_id')->nullable()->default(0)->index('parent_id');
            $table->string('name')->nullable()->default('');
            $table->integer('popular_seq')->nullable()->default(0);
        ...
        DB::table('categories')->insert(['id' => '999', 'parent_id' => '0', 'name' => 'N/A']);
        DB::table('categories')->insert(['id' => '1', 'parent_id' => '0', 'name' => 'High Volume Air Sampler', 'popular_seq' => 1]);
        ...
        DB::table('categories')->insert(['id' => '4', 'parent_id' => '0', 'name' => 'Air Sampler Impinger', 'popular_seq' => 2]);
        ...
        DB::table('categories')->insert(['id' => '8', 'parent_id' => '0', 'name' => 'Isokinetic Dust Sampler', 'popular_seq' => 3]);
        ...
        DB::table('categories')->where('id', 999)->update(['id' => 0]);
    }
